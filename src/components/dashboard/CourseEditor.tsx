...
/**
 * The five-step course editor.
 *
 * Rendered by the `/dashboard/courses/$courseId/edit` route so it sits inside
 * DashboardShell (sidebar and all) rather than dropping the tutor out into the
 * bare `_app` shell. `courseId` arrives as a prop rather than via `useParams` so
 * the component isn't welded to one route id.
 */
